...
object Day22 extends AdventOfCode {
  ...
  def part2(input: List[String]): String = {
    ...
    cubes.indices
      .foldLeft(0) { (acc, i) =>
        val fallingCubes =
          new mutable.HashSet[Int]().addAll(getCubesSupportedByOneCube(aSupportsB, bIsSupportedByA, i)) + i
  ...
  private def getCubesSupportedByOneCube(
      aSupportsB: Map[Int, Set[Int]],
      bIsSupportedByA: Map[Int, Set[Int]],
      i: Int
  ) = {
